 ...
 * Redeeem zDai.
 */
export async function redeemZDai(
  amount: string,
 ...
 */
export async function approveDai(
  lendingPool: any,
  web3State: any,
  primaryAddress: string,
  amount: number
  ...
  const allowance = await dai.methods
    .allowance(primaryAddress, lendingPool._address)
    .call();
  ...
  return new Promise((resolve, reject) =>
    dai.methods
      .approve(
        ...
        (amount * tokenDecimals).toLocaleString("fullwide", {
          useGrouping: false,
        })
      )
      .send({ from: primaryAddress })
...
export async function mintZDai(
  setProcessing: any,
  contract: any,
  web3State: any,
  primaryAddress: string,
  ...
  return new Promise((resolve, reject) =>
    contract.methods
      .deposit(
        (tokenDecimals * amount).toLocaleString("fullwide", {
          useGrouping: false,
        })
      )
      .send({ from: primaryAddress })
